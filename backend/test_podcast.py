...
print("=" * 60)
print("  FinSakhi Podcast API Test")
print("=" * 60)

# 1. Test /languages
print("\n1⃣  GET /api/podcasts/languages")
...
print("\n3⃣  POST /api/podcasts/generate (lesson 1, English)")
...
print("\n4⃣  POST /api/podcasts/generate (lesson 1, Hindi)")
r = requests.post(f"{BASE}/api/podcasts/generate", json={
    "lesson_id": 1,
    "language": "hi"
})
...
print("\n6⃣  GET /api/learning/lesson/1 (check podcast integration)")
